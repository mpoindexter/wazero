#!/bin/bash
# BenchmarkContextDoneOverhead across every approach, at GOMAXPROCS=1 and unset.
#
...
#
# Raw output lands in contextdone/<procs>/<config>.txt, where <procs> is "p1" or "pdefault"
...
FLAGS=(-test.run XXX -test.bench BenchmarkContextDoneOverhead -test.benchtime 500ms -test.count 1)
