...
func Test_ExecutionContextOffsets(t *testing.T) {
	...
	require.Equal(t, wazevoapi.Offset(unsafe.Offsetof(execCtx.matchExceptionTrampolineAddress)), wazevoapi.ExecutionContextOffsetMatchExceptionTrampolineAddress)
	require.Equal(t, wazevoapi.Offset(unsafe.Offsetof(execCtx.allocExceptionTrampolineAddress)), wazevoapi.ExecutionContextOffsetAllocExceptionTrampolineAddress)
	...
	require.Equal(t, wazevoapi.Offset(unsafe.Offsetof(execCtx.raiseRefTrampolineAddress)), wazevoapi.ExecutionContextOffsetRaiseRefTrampolineAddress)
